...
from lib.mysql_connect import add_table_manhattan_venues_meta
from lib.storage_scan_manhattan import save_venue_meta
import Queue
import threading
...
class ThreadUpdate(threading.Thread):
    ...
    def run(self):
        while True:
            ...
            #res = self.client.venues.search(params={'radius':200, 'll':str(mid_lat)+","+str(mid_lng), 'limit':50, 'intent':'checkin', 'categoryId':'4bf58dd8d48988d164941735'})
            herenow_sum = 0
            for r in res['venues']:
...
add_table_manhattan_venues_meta()
h = herenowUpdate()
